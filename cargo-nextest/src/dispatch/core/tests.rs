...
fn test_argument_parsing() {
    ...
    let valid: &[&'static str] = &[
        ...
        "cargo nextest store export-chrome-trace abc123",
        "cargo nextest store export-chrome-trace -R latest",
        "cargo nextest store export-chrome-trace --run-id abc123",
        "cargo nextest store export-chrome-trace latest -o trace.json",
        "cargo nextest store export-chrome-trace latest --output trace.json",
        "cargo nextest store export-chrome-trace archive.zip",
        "cargo nextest store export-chrome-trace /path/to/run.zip",
        "cargo nextest store export-chrome-trace -R ./relative/path.zip",
        "cargo nextest store export-chrome-trace /proc/self/fd/11",
        "cargo nextest store export-chrome-trace /dev/fd/5",
        "cargo nextest store export-chrome-trace latest --group-by binary",
        "cargo nextest store export-chrome-trace latest --group-by slot",
        "cargo nextest store export-chrome-trace latest --message-format json",
    ...
    let invalid: &[(&'static str, ErrorKind)] = &[
        ...
        // build-dir-remap requires binaries-metadata (conflicts with archive)
        (
            "cargo nextest run --build-dir-remap bar",
            MissingRequiredArgument,
        ),
        (
            "cargo nextest run --archive-file foo --build-dir-remap bar",
            ArgumentConflict,
        ),
