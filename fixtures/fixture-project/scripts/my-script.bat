...
if defined CMD_ENV_VAR_CARGO (
    ECHO SCRIPT_CMD_ENV_VAR_CARGO=%CMD_ENV_VAR_CARGO%>> %NEXTEST_ENV%
)
if defined WRAPPER_CMD_ENV_VAR (
    ECHO SCRIPT_WRAPPER_CMD_ENV_VAR=%WRAPPER_CMD_ENV_VAR%>> %NEXTEST_ENV%
)
