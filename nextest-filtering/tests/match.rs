...
use nextest_filtering::{
    ...
    BinaryQuery, BoxedFilteringExpr, TestQuery,
};
...
fn test_expr_package_contains() {
    ...
    let expr = BoxedFilteringExpr::parse("package(~_a)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_package_equal() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("package(=crate_a)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_package_regex() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("package(/crate_(a|b)/)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_deps() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("deps(crate_d)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_rdeps() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("rdeps(crate_d)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_with_no_matching_packages() {
    ...
    let graph = load_graph();
    let errors = BoxedFilteringExpr::parse("deps(does-not-exist)", &graph).unwrap_err();
    assert_error(&errors);
    ...
    let errors = BoxedFilteringExpr::parse("deps(/does-not/)", &graph).unwrap_err();
    assert_error(&errors);
}
...
fn test_expr_kind() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("kind(lib)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_binary() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("binary(my-binary)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_platform() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("platform(host)", &graph).unwrap();
    println!("{:?}", expr);
    ...
    let expr = BoxedFilteringExpr::parse("platform(target)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_kind_partial() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("kind(~tes)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_test() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("test(parse)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_test_not() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse("not test(parse)", &graph).unwrap();
    println!("{:?}", expr);
...
fn test_expr_test_union(input: &str) {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse(input, &graph).unwrap();
    println!("{:?}", expr);
...
fn test_binary_query() {
    let graph = load_graph();
    let expr = BoxedFilteringExpr::parse(
