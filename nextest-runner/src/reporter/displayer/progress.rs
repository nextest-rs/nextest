...
impl ProgressBarState {
    ...
    pub(super) fn update_progress_bar(&mut self, event: &TestEvent<'_>, styles: &Styles) {
        ...
        match &event.kind {
            ...
            TestEventKind::TestFinished {
                ...
                self.delete_test_bar(&test_instance.suite_info.binary_id, test_instance.name);
    ...
    fn delete_test_bar(&mut self, binary_id: &RustBinaryId, test_name: &str) {
        if let Some(test_bars) = &mut self.test_bars {
