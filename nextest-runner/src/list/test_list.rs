...
pub struct SkipCounts {
    ...
    pub skipped_tests_default_set: usize,
    ...
    pub skipped_binaries_default_set: usize,
}
...
impl<'g> TestList<'g> {
    ...
    pub fn skip_counts(&self) -> &SkipCounts {
        self.skip_counts.get_or_init(|| {
            ...
            let mut skipped_binaries_default_set = 0;
            ...
            SkipCounts {
                skipped_tests,
                skipped_tests_default_set,
                skipped_binaries,
                skipped_binaries_default_set,
            }
        })
    }
    ...
    pub fn to_summary(
        ...
        match self {
            ...
            Self::Skipped {
                ...
                RustTestSuiteStatusSummary::SKIPPED_DEFAULT_SET,
                BTreeMap::new(),
            ),
        }
    }
