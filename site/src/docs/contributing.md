...
We welcome LLM-assisted contributions that aim for a high standard of excellence. See [AGENTS.md, For humans](https://github.com/nextest-rs/nextest/blob/main/AGENTS.md#for-humans).
