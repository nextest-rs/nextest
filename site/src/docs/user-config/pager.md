...
- [`cargo nextest replay`](../features/record-replay-rerun/replay.md) — replay recorded test runs
- [`cargo nextest store list`](../features/record-replay-rerun/managing-runs.md#listing-recorded-runs) — list recorded test runs
