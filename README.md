...
The minimum supported Rust version is **Rust 1.62.** At least the last 3 versions of stable Rust are supported at any given time; see the [stability policy](https://nexte.st/book/stability) for more details.
